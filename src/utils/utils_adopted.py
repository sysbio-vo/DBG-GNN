"""
Taken from https://github.com/ratschlab/genomic-gnn
"""
...
def build_deBruijn_graph(
    ...
    **attrs
    ...
    # Create deBruji directed graph with given attributes
    deBruijn_graph = nx.DiGraph(**attrs)
    ...
    for pair in tqdm(
        pair_frequency, desc="Creating DeBruijn Graph", disable=disable_tqdm
    ):
        x, y = pair
